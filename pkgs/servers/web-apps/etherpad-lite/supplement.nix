...
let
  sources = {
    ...
    "empty-dir-0.1.0" = {
      ...
      version = "0.1.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/empty-dir/-/empty-dir-0.1.0.tgz";
        sha1 = "4915bd8b63773c3f458b2dc50339c908849c84f0";
      };
    };
  };
in
{
  sqlite3 = nodeEnv.buildNodePackage {
    name = "sqlite3";
    packageName = "sqlite3";
    version = "3.1.13";
    src = fetchurl {
  ...
  mysql = nodeEnv.buildNodePackage {
    name = "mysql";
    packageName = "mysql";
    version = "2.15.0";
    src = fetchurl {
  ...
  postgresql = nodeEnv.buildNodePackage {
    name = "postgresql";
    packageName = "postgresql";
    version = "0.0.1";
    src = fetchurl {
      url = "https://registry.npmjs.org/postgresql/-/postgresql-0.0.1.tgz";
      sha1 = "f07c179d937e0c54ee735a15eb2e462b1967ab70";
    };
    dependencies = [
      sources."empty-dir-0.1.0"
    ];
    buildInputs = globalBuildInputs;
    meta = {
